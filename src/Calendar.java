...
public class Calendar {
	 ...
	 * 
	 * Meal Name Mon Tues Wed Thur Fri Sat Sun Breakfast Meal Meal Meal Meal Meal
	 * Meal Meal Lunch Meal Meal Meal Meal Meal Meal Meal Snack Meal Meal Meal Meal
	 * Meal Meal Meal Dinner Meal Meal Meal Meal Meal Meal Meal
	 */
	public Calendar() {
	 ...
	 * and meal selected and adds the dish name instead of "meal" string
	 * 
	...
	/**
	 * The following method removes a meal from the calendar and places the word
	 * "meal" as a placeholder
	 * 
	 * @param mealName     i.e. lunch, dinner, snack, etc.
	 * @param dayOfTheWeek i.e. Sunday
	 * @return updated calendar
	...
	/**
	 * The following method replaces a meal on the calendar with another meal from
	 * the calendar
	 * 
	 ...
	 * @return updated calendar
	 */
	public String[][] replaceAMealWithAnother(String mealNameToBeReplaced, String dayOfTheWeekToBeReplaced,
			String mealNameReplacedWith, String dayOfTheWeekReplacedWith) {
		// TODO update the calendar to replace the old dish with the new dish on the
		// appropriate day
		return calendar;
	}
