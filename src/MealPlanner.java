...
public class MealPlanner {
	...
	public void run() {
		 ...
		 * open and get lines from the old meal plan file. Exception handling should be included
		 */

		//add code here evaluate (else block) whether the user asked to create a new meal plan here
		
		//ask whether the user wants a default serving size? If so provide the number of people that the
		//recipe should serve to and store it in a variable
		
		//create an empty grocery list
		
		//while loop - do the following until the user clicks the "done with mealplan" button
		
			//create a new API handler and parser object and get parsed information from it
		
			//create a new dish object
			
			//if the serving size is greater than the user then use the converter class to convert
		 ...
		 *while loop and the calendar replace a meal, remove a meal or add a meal method
		...
		//save the meal plan and recipe to a .csv file using a predefined mechanism that can be parsed easily
