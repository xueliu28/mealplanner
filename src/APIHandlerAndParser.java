...
/**
 * The following class pulls information from a
 * public API and stores in the appropriate data structure
 * Temporarily, I used ArrayList, but we may use JSON object as
 * a data type to store or gather info.
 */
public class APIHandlerAndParser {
	private ArrayList <String> infoFromAPI;
	
	/**
	 * The following constructor creatworks with a public API
